<template>
    ...
    <div>
      ...
      <div v-if="listing_type === 'sellOrGive'">
      ...
      <div>
        ...
        <input type="text" v-model="product_quantity_box"  placeholder="Put a value" v-if="product_quantity === 'Others'" />
      </div>
      ...
      <div>
        ...
        <input type="text" placeholder="Specify size of product in ml" v-model="product_size_ml" />
      </div>
      ...
      <button v-on:click="addProduct" v-if="listing_type === 'sellOrGive'">Add Product</button>
      ...
      <div v-else>
        <ul>
          ...
          <li>Please specify category: {{product_category_others}}</li>
